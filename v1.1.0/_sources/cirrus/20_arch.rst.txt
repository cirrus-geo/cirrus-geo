...
an input Cirrus Payload to define input metadata/assets for the Task
...
**task**: A single function operating on a Cirrus Payload running on Lambda or Batch

**workflow**: An AWS Step Function consisting of 1 or more tasks

**feeder**: Anything that generates a :doc:`Cirrus Payload <../30_payload>` and queues it for processing.
