...
* lambda functions: AWS Lambda functions used to manage payload flow into and
   out of cirrus, and manage state updates
...
* feeders: Conceptually, anything that generates a :doc:`Cirrus Process Payload <../30_payload>` and queues it for processing. In practice this is open
